...
class TestOllamaProvider:
    ...
    async def test_generate_success(self, provider):
        ...
        mock_response.json.return_value = {"response": "Para obtener una visa de trabajo en Canadá..."}
    ...
    async def test_generate_with_context(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Basándome en tu perfil..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            context = {"nationality": "Colombian", "destination": "Canada", "visa_type": "work"}

            result = await provider.generate("¿Qué documentos necesito?", context=context)
    ...
    async def test_check_availability(self, provider):
        ...
        mock_response.json.return_value = {"models": [{"name": "migpal:latest"}]}
...
class TestMigrationQueries:
    ...
    async def test_visa_requirements_query(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Los requisitos para una visa de trabajo incluyen..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("¿Cuáles son los requisitos para una visa de trabajo en Canadá?")
    ...
    async def test_document_checklist_query(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Documentos necesarios: 1. Pasaporte vigente..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("Dame una lista de documentos para visa de estudiante")
    ...
    async def test_processing_time_query(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "El tiempo de procesamiento es de 6-8 meses..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("¿Cuánto tiempo tarda el proceso de visa?")
...
class TestAIResponseQuality:
    ...
    async def test_response_not_empty(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Respuesta detallada sobre el proceso..."}
        mock_response.raise_for_status = MagicMock()
    ...
    async def test_handles_spanish_queries(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Para emigrar a Canadá desde Colombia..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("¿Cómo puedo emigrar a Canadá desde Colombia?")
    ...
    async def test_handles_english_queries(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "To apply for a Canadian work permit..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("How can I apply for a Canadian work permit?")
...
class TestEdgeCases:
    ...
    async def test_very_long_query(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Respuesta procesada..."}
        mock_response.raise_for_status = MagicMock()
    ...
    async def test_special_characters(self, provider):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("¿Cómo aplico? ¡Necesito ayuda! @#$%")
    ...
    async def test_unicode_characters(self, provider):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {"response": "Respuesta Unicode..."}
        mock_response.raise_for_status = MagicMock()
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await provider.generate("¿Cómo emigrar? 🌍✈️🇨🇦")
