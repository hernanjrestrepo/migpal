...
class TestConfirmNameTransition:
    ...
    def test_confirm_name_finds_name_from_onboarding(self):
        ...
        assert "profile" in content and "personal" in content and "name" in content, \
            "El handler debe buscar el nombre en profile.personal.name"
        
        # Debe tener el fix v3.0.7
        assert "v3.0.7" in content or "onboarding" in content.lower(), \
...
class TestOnboardingTransitions:
    ...
    def test_lang_selection_advances_to_onboarding(self):
        ...
        from app.services.case_storage import save_user_data, delete_user_data
        from app.services.telegram_bot import set_state, get_state
        ...
        try:
            ...
            assert state == OnboardingState.WELCOME.value, \
    ...
    def test_onboarding_yes_advances_to_name(self):
        ...
        try:
            ...
            assert state == OnboardingState.NAME_REQUEST.value, \
...
class TestFullFlowE2E:
    ...
    def test_full_flow_completes(self):
        ...
        try:
            ...
            for current, action, expected in states_flow:
