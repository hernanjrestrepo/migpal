...
class TestOnboardingNoFormulario:
    ...
    def test_first_message_is_not_form(self):
        ...
        from app.services.onboarding_v306 import OnboardingMessages, validate_onboarding_flow, OnboardingState
        ...
        for keyword in form_keywords:
            assert keyword.lower() not in welcome_es.lower(), \
                f"El mensaje de bienvenida contiene '{keyword}' que es de formulario"
            assert keyword.lower() not in welcome_en.lower(), \
    ...
    def test_first_state_is_onboarding(self):
        ...
        from app.services.onboarding_v306 import OnboardingState, ONBOARDING_STATES, is_form_state
    ...
    def test_validate_onboarding_flow(self):
        ...
        from app.services.onboarding_v306 import validate_onboarding_flow, OnboardingState, OnboardingMessages
...
class TestOnboardingFlow:
    ...
    def test_open_question_exists(self):
        ...
        for q in questions:
            ...
            assert "qué" in q.lower() or "cómo" in q.lower(), \
                "Las preguntas deben ser abiertas (qué, cómo)"
...
class TestOnboardingEngine:
    ...
    def test_get_empathic_response(self):
        ...
        assert "trabajo" in response.lower() or "profesional" in response.lower() or "valiente" in response.lower()
...
class TestE2EOnboarding:
    ...
    def test_start_command_does_not_show_form(self):
        ...
        start_handler = re.search(
            r'async def _cmd_start\(self.*?(?=async def |$)',
            content,
            re.DOTALL
        )
        ...
        assert "OnboardingState" in handler_code or "onboarding" in handler_code.lower(), \
