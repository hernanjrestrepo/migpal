...
class TestStartupValidator:
    ...
    def test_validate_form_states_all_valid(self):
        ...
        from app.services.telegram_bot import (
            STATE_NAME, STATE_BIRTH_DATE, STATE_CURRENT_CITY,
            STATE_EMAIL, STATE_PHONE
        )
    ...
    def test_validate_all_states_returns_report(self):
        ...
        from app.services.ux_improvements import StartupValidator
        from app.services.telegram_bot import (
            STATE_NAME, STATE_BIRTH_DATE, STATE_START
        )
    ...
    def test_run_startup_check_passes(self):
        ...
        from app.services.telegram_bot import (
            STATE_NAME, STATE_BIRTH_DATE, STATE_CURRENT_CITY,
            STATE_EMAIL, STATE_PHONE, STATE_EDUCATION_CAREER,
            STATE_PROFESSION, STATE_LINKEDIN, STATE_TIMELINE,
            STATE_BUDGET_INITIAL, STATE_SAVINGS,
...
class TestStallDetector:
    ...
    def test_repeated_messages_detection(self):
        ...
        from app.services.ux_improvements import StallDetector, MAX_REPEATED_MESSAGES
...
class TestIntegration:
    ...
    def test_bot_imports_ux_module(self):
        ...
        from app.services.telegram_bot import (
            get_exception_handler, get_stall_detector, get_progress_tracker,
            get_transition_logger, global_error_handler
        )
