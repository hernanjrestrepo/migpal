...
from .phase_manager import MIGRANT_TYPE_INFO, MigrantType, Phase
...
class DeliverableGenerator:
    ...
    def generate(self, user_id: int, phase: Phase, user_data: dict[str, Any]) -> Deliverable:
        ...
        return Deliverable(
            phase=phase, title="Documento no disponible", content="No hay entregable definido para esta fase."
        )
...
"""
        ...
        return Deliverable(phase=Phase.REGISTRO, title="Resumen de Registro", content=content, is_pdf=False)
    ...
    def _generate_diagnosis_report(self, user_id: int, data: dict) -> Deliverable:
        ...
        data.get("migrant_type", "empleado")
...
"""
        ...
        return Deliverable(
            phase=Phase.EJECUCION, title="Confirmación de Envío", content=content, is_pdf=False
        )
...
_generator: DeliverableGenerator | None = None
...
def generate_phase_deliverable(
    user_id: int, phase: Phase, user_data: dict[str, Any], pdf_generator=None
) -> Deliverable:
    """
