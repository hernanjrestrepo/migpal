...
CHECKLIST_DEFINITION = {
    ChecklistCategory.FAMILIA: {
        "fields": [
            {"name": "has_family", "required": True, "question_es": "¿Viajas solo o con familia?", "question_en": "Are you traveling alone or with family?"},
            {"name": "family_count", "required": False, "question_es": "¿Cuántas personas viajan contigo?", "question_en": "How many people are traveling with you?"},
            {"name": "children_ages", "required": False, "question_es": "¿Qué edades tienen tus hijos?", "question_en": "How old are your children?"},
            {"name": "spouse_profession", "required": False, "question_es": "¿A qué se dedica tu pareja?", "question_en": "What does your spouse do?"},
        ],
        "priority": 1,
    ...
    ChecklistCategory.EDAD: {
        "fields": [
            {"name": "birth_date", "required": True, "question_es": "¿Cuál es tu fecha de nacimiento?", "question_en": "What is your date of birth?"},
            {"name": "age", "required": True, "question_es": "¿Cuántos años tienes?", "question_en": "How old are you?"},
        ],
        "priority": 2,
    ...
    ChecklistCategory.IDIOMA: {
        "fields": [
            {"name": "english_level", "required": True, "question_es": "¿Cuál es tu nivel de inglés?", "question_en": "What is your English level?"},
            {"name": "other_languages", "required": False, "question_es": "¿Hablas otros idiomas?", "question_en": "Do you speak other languages?"},
        ],
        "priority": 3,
    ...
    ChecklistCategory.PRESUPUESTO: {
        "fields": [
            {"name": "savings", "required": True, "question_es": "¿Cuánto tienes ahorrado aproximadamente?", "question_en": "How much do you have saved approximately?"},
            {"name": "monthly_income", "required": False, "question_es": "¿Cuál es tu ingreso mensual?", "question_en": "What is your monthly income?"},
            {"name": "investment_capacity", "required": False, "question_es": "¿Tienes capacidad de inversión?", "question_en": "Do you have investment capacity?"},
        ],
        "priority": 4,
    ...
    ChecklistCategory.ESTATUS: {
        "fields": [
            {"name": "current_visa", "required": False, "question_es": "¿Tienes alguna visa actualmente?", "question_en": "Do you currently have any visa?"},
            {"name": "visa_history", "required": True, "question_es": "¿Has tenido visas antes? ¿Cuáles?", "question_en": "Have you had visas before? Which ones?"},
            {"name": "visa_denials", "required": True, "question_es": "¿Te han negado alguna visa?", "question_en": "Have you been denied any visa?"},
            {"name": "legal_issues", "required": True, "question_es": "¿Tienes algún problema legal o antecedente?", "question_en": "Do you have any legal issues or records?"},
        ],
        "priority": 5,
    ...
    ChecklistCategory.OBJETIVO_USA: {
        "fields": [
            {"name": "migration_reason", "required": True, "question_es": "¿Por qué quieres migrar a USA?", "question_en": "Why do you want to migrate to the USA?"},
            {"name": "target_state", "required": False, "question_es": "¿Tienes algún estado en mente?", "question_en": "Do you have any state in mind?"},
            {"name": "timeline", "required": True, "question_es": "¿En cuánto tiempo te gustaría migrar?", "question_en": "When would you like to migrate?"},
            {"name": "has_contacts_usa", "required": False, "question_es": "¿Tienes familia o contactos en USA?", "question_en": "Do you have family or contacts in the USA?"},
        ],
        "priority": 6,
...
PROFESSIONAL_FIELDS = {
    "profession": {"required": True, "question_es": "¿Cuál es tu profesión?", "question_en": "What is your profession?"},
    "education_level": {"required": True, "question_es": "¿Cuál es tu nivel educativo?", "question_en": "What is your education level?"},
    "experience_years": {"required": True, "question_es": "¿Cuántos años de experiencia tienes?", "question_en": "How many years of experience do you have?"},
    "achievements": {"required": False, "question_es": "¿Tienes logros destacados en tu campo?", "question_en": "Do you have notable achievements in your field?"},
}
...
class ProfileChecklist:
    ...
    def get_next_question(self, user_id: int, lang: str = "es") -> Optional[Tuple[str, str]]:
        """
        ...
        for category in sorted(CHECKLIST_DEFINITION.keys(), key=lambda c: CHECKLIST_DEFINITION[c]["priority"]):
...
# Singleton instance
_profile_checklist: Optional[ProfileChecklist] = None
