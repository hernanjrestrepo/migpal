...
class CityComparator:
    ...
    def compare(self, city1: dict, city2: dict) -> ComparisonResult:
        ...
        for cat_id, _cat_name, lower_is_better in self.CATEGORIES:
    ...
    def _format_comparison(
        self, city1: dict, city2: dict, winners: dict, scores: dict, overall_winner: str
    ) -> str:
        """Formatea la comparación para Telegram"""
        name1 = city1["name"]
        name2 = city2["name"]

        msg = "⚔️ *COMPARACIÓN DE CIUDADES*\n\n"
...
class CityFormatter:
    ...
    def _format_conclusion(self, city: dict) -> str:
        ...
        msg += "🔗 Más info: /viviendas para ver casas\n"
