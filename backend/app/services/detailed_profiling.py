...
class ProfileField:
    ...
    depends_on: Optional[str] = None  # Campo del que depende
    depends_value: Optional[Any] = None  # Valor que activa este campo
    help_text: str = ""
    example: str = ""
    order: int = 0
    emoji: str = "📝"
...
register_field(ProfileField(
    ...
    required=True,
    options=["Colombiana", "Mexicana", "Venezolana", "Argentina", "Peruana", "Chilena", "Ecuatoriana", "Brasileña", "Española", "Estadounidense", "Otra"],
...
register_field(ProfileField(
    ...
    field_type=FieldType.SELECT,
    required=True,
    options=["Colombia", "México", "Venezuela", "Argentina", "Perú", "Chile", "Ecuador", "Brasil", "España", "Estados Unidos", "Otro"],
    order=8,
    emoji="📍"
))
...
register_field(ProfileField(
    ...
    field_type=FieldType.MULTI_SELECT,
    required=False,
    options=["Inglés", "Francés", "Alemán", "Italiano", "Portugués", "Mandarín", "Japonés", "Coreano", "Otro"],
    order=13,
    emoji="🌐"
))
...
register_field(ProfileField(
    ...
    field_type=FieldType.SELECT,
    required=True,
    options=["Nativo", "Avanzado (C1-C2)", "Intermedio Alto (B2)", "Intermedio (B1)", "Básico (A1-A2)", "Ninguno"],
...
register_field(ProfileField(
    ...
    required=True,
    options=[
        "Florida", "California", "Texas", "New York", "New Jersey",
        "Illinois", "Georgia", "North Carolina", "Arizona", "Colorado",
        "Washington", "Massachusetts", "Virginia", "Nevada", "Oregon",
        "Sin preferencia"
    ],
    order=121,
    emoji="🗺️"
...
class DetailedProfiler:
    ...
    def get_pending_fields(self, section: Optional[ProfileSection] = None) -> List[ProfileField]:
    ...
    def get_next_field_to_complete(self) -> Optional[ProfileField]:
