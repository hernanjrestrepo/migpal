...
class DocumentRequirement:
    ...
    validity_period: Optional[str] = None  # Período de validez
...
register_document(DocumentRequirement(
    id="passport",
...
""",
    ...
    common_mistakes=[
        "Usar agencias no autorizadas",
        "No solicitar evaluación curso por curso"
    ],
    estimated_time="2-4 semanas",
...
""",
    ...
    tips=[
        "Guarda todos tus recibos digitalmente",
...
""",
    ...
    tips=[
        "Muestra ingresos consistentes",
        "Incluye certificados de retención"
    ],
    common_mistakes=[
...
""",
    ...
    common_mistakes=[
        "No explicar la importancia del premio",
        "Premios sin documentación de respaldo"
    ],
...
""",
    ...
    common_mistakes=[
        "Solo incluir menciones breves",
        "No documentar la importancia del medio"
    ],
    estimated_time="Variable",
    cost_estimate="Gratis",
    emoji="📰"
...
""",
    ...
    common_mistakes=[
        "No incluir métricas de citas",
        "Publicaciones en revistas no reconocidas"
    ],
    estimated_time="Inmediato si los tienes",
    cost_estimate="Gratis",
    emoji="📄"
...
""",
    ...
    common_mistakes=[
        "No explicar la importancia de la patente",
        "Olvidar patentes en proceso"
    ],
...
""",
    ...
    common_mistakes=[
        "Usar médico no autorizado",
        "Abrir el sobre sellado",
        "Examen vencido"
    ],
    estimated_time="1-2 semanas",
...
""",
    ...
    tips=[
        "Actualiza vacunas faltantes antes del examen",
        "COVID-19 es requerida para inmigrantes"
    ],
    common_mistakes=[
        "Vacunas incompletas",
        "Registros perdidos"
...
class DocumentChecklist:
    ...
    def update_status(self, doc_id: str, status: DocumentStatus, file_path: Optional[str] = None, notes: str = ""):
