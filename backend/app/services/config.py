...
class Config:
    ...
    ENCRYPTION_KEY: str = os.getenv(
        "MIGPAL_ENCRYPTION_KEY", 
        "migpal_default_key_change_in_production_2026"
    )
    ...
    USCIS_API_KEY: Optional[str] = os.getenv("USCIS_API_KEY")
    IRCC_API_KEY: Optional[str] = os.getenv("IRCC_API_KEY")
    
    @classmethod
    def ensure_directories(cls):
        """Create necessary directories if they don't exist"""
        for dir_path in [cls.DATA_DIR, cls.CASES_DIR, cls.REPORTS_DIR, 
