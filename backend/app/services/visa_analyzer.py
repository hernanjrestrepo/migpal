...
class VisaAnalyzer:
    ...
    def _evaluate_visa(self, visa_type: VisaType, visa_info: VisaInfo) -> Optional[VisaRecommendation]:
        ...
        has_job_offer = self.profile.get("job_offer_usa", "") in ["Sí, oferta formal firmada", "Sí, oferta verbal"]
        ...
        family_in_usa = self.profile.get("family_in_usa", False)
...
"""
    ...
    def get_best_recommendation(self) -> Optional[VisaRecommendation]:
...
def get_visa_info(visa_type: VisaType) -> Optional[VisaInfo]:
