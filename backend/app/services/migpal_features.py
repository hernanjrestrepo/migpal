    ...
    "USA": {
        "H-1B": [
            {
                ...
                "required": True,
                "validity": "6+ meses",
                "notes": "Debe tener al menos 6 meses de vigencia",
            },
            {
                "name": "Título universitario",
                "required": True,
                "validity": None,
                "notes": "Original y traducción certificada",
            },
            {
                "name": "Certificado de notas",
                "required": True,
                "validity": None,
                "notes": "Transcript oficial",
            },
            {
                "name": "Carta de oferta laboral",
                "required": True,
                "validity": None,
                "notes": "De empresa americana",
            },
            {"name": "CV/Resume", "required": True, "validity": None, "notes": "Formato americano"},
            {
                ...
                "required": True,
                "validity": None,
                "notes": "De empleos anteriores",
            },
            {
                "name": "Fotos tipo pasaporte",
                "required": True,
                "validity": None,
                "notes": "2x2 pulgadas, fondo blanco",
            },
        ...
        "F-1": [
            ...
            {"name": "Formulario I-20", "required": True, "validity": None, "notes": "De la universidad"},
            {
                ...
                "required": True,
                "validity": None,
                "notes": "Para cubrir estudios y manutención",
            },
            {
                "name": "Certificados académicos",
                "required": True,
                "validity": None,
                "notes": "Títulos y notas",
            },
        ...
        "DV Lottery": [
            ...
            {"name": "Certificado de nacimiento", "required": True, "validity": None, "notes": ""},
            {
                ...
                "required": True,
                "validity": "6 meses",
                "notes": "De cada país donde vivió",
            },
            {
                "name": "Examen médico",
                "required": True,
                "validity": "6 meses",
                "notes": "Con médico autorizado",
            },
        ],
    },
    "Canadá": {
        "Express Entry": [
            {"name": "Pasaporte vigente", "required": True, "validity": "6+ meses", "notes": ""},
            {
                ...
                "required": True,
                "validity": "2 años",
                "notes": "IELTS General o CELPIP",
            },
            {
                "name": "ECA (Evaluación de credenciales)",
                "required": True,
                "validity": "5 años",
                "notes": "WES u otra agencia",
            },
            {
                "name": "Cartas de experiencia laboral",
                "required": True,
                "validity": None,
                "notes": "Detalladas con funciones",
            },
    ...
    "España": {
        "Trabajo": [
            {"name": "Pasaporte vigente", "required": True, "validity": "4+ meses", "notes": ""},
            {
                ...
                "required": True,
                "validity": None,
                "notes": "Visado por autoridad laboral",
            },
        ...
        "Estudiante": [
            ...
            {
                "name": "Carta de admisión",
                "required": True,
                "validity": None,
                "notes": "De centro autorizado",
            },
        ...
        "Nómada Digital": [
            ...
            {
                "name": "Contrato de trabajo remoto",
                "required": True,
                "validity": None,
                "notes": "Con empresa extranjera",
            },
    ...
    "Alemania": {
        "Blue Card": [
            {"name": "Pasaporte vigente", "required": True, "validity": "3+ meses post-visa", "notes": ""},
            {
                ...
                "required": True,
                "validity": None,
                "notes": "Reconocido en Alemania",
            },
            {
                "name": "Contrato de trabajo",
                "required": True,
                "validity": None,
                "notes": "Salario mínimo €45,300",
            },
        ...
        "Estudiante": [
            {"name": "Pasaporte vigente", "required": True, "validity": "Duración estudios", "notes": ""},
            {
                ...
                "required": True,
                "validity": None,
                "notes": "De universidad alemana",
            },
            {
                "name": "Prueba de fondos",
                "required": True,
                "validity": None,
                "notes": "€11,208/año en cuenta bloqueada",
            },
        ...
        "H-1B": [
            {
                ...
                "name": "📋 Preparación",
                "duration": "1-2 meses",
                "tasks": ["Reunir documentos", "Encontrar empleador sponsor"],
            },
            {
                "stage": "petition",
                "name": "📝 Petición I-129",
                "duration": "Variable",
                "tasks": ["Empleador presenta petición", "Pago de fees"],
            },
            {
                "stage": "lottery",
                "name": "🎲 Lotería (Abril)",
                "duration": "2-4 semanas",
                "tasks": ["Esperar selección", "Solo aplica si hay cap"],
            },
            {
                "stage": "processing",
                "name": "⏳ Procesamiento",
                "duration": "3-6 meses",
                "tasks": ["USCIS revisa petición", "Posible RFE"],
            },
            {
                "stage": "approval",
                "name": "✅ Aprobación",
                "duration": "1-2 semanas",
                "tasks": ["Recibir Notice of Approval"],
            },
            {
                "stage": "consular",
                "name": "🏛️ Proceso Consular",
                "duration": "1-3 meses",
                "tasks": ["Agendar cita", "Entrevista", "Visa stamping"],
            },
            {
                "stage": "travel",
                "name": "✈️ Viaje",
                "duration": "Flexible",
                "tasks": ["Planificar llegada", "Iniciar trabajo"],
            },
        ],
        "F-1": [
            {
                ...
                "name": "🎓 Admisión",
                "duration": "2-6 meses",
                "tasks": ["Aplicar a universidades", "Recibir I-20"],
            },
            {
                "stage": "sevis",
                "name": "💳 SEVIS",
                "duration": "1 semana",
                "tasks": ["Pagar fee I-901", "Activar SEVIS"],
            },
            {
                "stage": "ds160",
                "name": "📝 DS-160",
                "duration": "1-2 horas",
                "tasks": ["Completar formulario online"],
            },
            {
                "stage": "interview",
                "name": "🏛️ Entrevista",
                "duration": "1-4 semanas",
                "tasks": ["Agendar cita", "Preparar documentos", "Asistir"],
            },
            {
                "stage": "visa",
                "name": "📄 Visa",
                "duration": "1-2 semanas",
                "tasks": ["Esperar visa", "Recoger pasaporte"],
            },
            {
                "stage": "travel",
                "name": "✈️ Viaje",
                "duration": "Flexible",
                "tasks": ["Llegar máximo 30 días antes"],
            },
        ],
    },
    "Canadá": {
        "Express Entry": [
            {
                ...
                "name": "📋 Preparación",
                "duration": "2-4 meses",
                "tasks": ["IELTS", "ECA", "Reunir documentos"],
            },
            {
                "stage": "profile",
                "name": "👤 Crear Perfil",
                "duration": "1-2 horas",
                "tasks": ["Registrarse en Express Entry", "Calcular CRS"],
            },
            {
                "stage": "pool",
                "name": "🏊 En el Pool",
                "duration": "Variable",
                "tasks": ["Esperar ITA", "Mejorar perfil si es posible"],
            },
            {
                "stage": "ita",
                "name": "📨 ITA Recibida",
                "duration": "60 días límite",
                "tasks": ["Completar aplicación", "Subir documentos"],
            },
            {
                "stage": "processing",
                "name": "⏳ Procesamiento",
                "duration": "6-8 meses",
                "tasks": ["Esperar decisión", "Examen médico", "Biométricos"],
            },
            {
                "stage": "copr",
                "name": "✅ COPR",
                "duration": "1-2 semanas",
                "tasks": ["Recibir Confirmation of PR"],
            },
            {
                "stage": "landing",
                "name": "🛬 Landing",
                "duration": "Flexible",
                "tasks": ["Viajar a Canadá", "Activar PR"],
            },
        ],
    },
    "España": {
        "Trabajo": [
            {
                ...
                "name": "💼 Oferta Laboral",
                "duration": "Variable",
                "tasks": ["Conseguir oferta de empresa española"],
            },
            {
                "stage": "authorization",
                "name": "📋 Autorización",
                "duration": "1-3 meses",
                "tasks": ["Empresa solicita autorización laboral"],
            },
            {
                "stage": "visa",
                "name": "🏛️ Solicitud Visa",
                "duration": "1-2 meses",
                "tasks": ["Presentar en consulado", "Entrevista"],
            },
            {
                "stage": "approval",
                "name": "✅ Aprobación",
            ...
            },
            {
                "stage": "travel",
                "name": "✈️ Viaje",
                "duration": "90 días límite",
                "tasks": ["Viajar a España"],
            },
            {
                "stage": "nie",
                "name": "🪪 NIE/TIE",
                "duration": "1 mes",
                "tasks": ["Solicitar tarjeta de residencia"],
            },
        ],
    },
}
...
SETTLEMENT_GUIDES = {
    ...
    "Canadá": {
        ...
        "sin": {
            ...
            "tips": ["💡 Aplica lo antes posible", "💡 Puedes aplicar online si tienes PR card"],
        },
        "health": {
