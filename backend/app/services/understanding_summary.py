...
class UnderstandingSummaryManager:
    ...
    def generate_summary_text(self, user_data: Dict[str, Any], lang: str = "es") -> Tuple[str, List[Tuple[str, str]]]:
        """
        ...
        if lang == "es":
            ...
            summary += "Antes de darte recomendaciones, quiero asegurarme de que entendí bien tu situación:\n\n"
    ...
    def should_show_summary(self, user_id: int, user_data: Dict[str, Any]) -> bool:
        ...
        has_other = bool(
            personal.get("nationality") or
            personal.get("birth_date") or
            profile.get("work", {}).get("profession") or
            user_data.get("preferences", {}).get("migration_reason")
        )
