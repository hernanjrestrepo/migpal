...
class HousingSearchEngine:
    ...
    async def search_properties(
        ...
        api_properties = await self._search_realtor16(
            city, state, listing_type, property_type, min_price, max_price, min_beds, limit
        )
    ...
    async def _search_realtor16(
        ...
        try:
            ...
            headers = {"x-rapidapi-host": REALTOR16_API_HOST, "x-rapidapi-key": RAPIDAPI_KEY}
            ...
            if response.status_code == 200:
                ...
                for prop in prop_list[:limit]:
                    ...
                    listing_url = (
                        ...
                        if permalink
                        else f"https://www.realtor.com/realestateandhomes-search/{city.replace(' ', '-')}_{state}"
                    )
    ...
    async def _search_us_real_estate(
        ...
        try:
            ...
            params = {"state_code": state.upper(), "city": city, "limit": str(min(limit, 50)), "offset": "0"}
            ...
            headers = {"x-rapidapi-host": US_REAL_ESTATE_HOST, "x-rapidapi-key": RAPIDAPI_KEY}
                ...
                for prop in results[:limit]:
                    ...
                    properties.append(
                        PropertyListing(
                            ...
                            zip_code=address.get("postal_code", ""),
                            neighborhood=(
                                location.get("neighborhoods", [{}])[0].get("name", "")
                            ...
                            listing_url=prop.get(
                                "href", f"https://www.realtor.com/realestateandhomes-search/{city}_{state}"
                            ),
                            source="realtor.com",
