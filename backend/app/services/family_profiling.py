...
class FamilyInvitation:
    ...
    accepted_by_telegram_id: Optional[int] = None
...
FAMILY_MEMBER_FIELDS = {
    FamilyRole.SPOUSE: [
        ...
        {"id": "birth_country", "name": "País de Nacimiento", "required": True, "type": "select", "emoji": "🌍",
         "options": ["Colombia", "México", "Venezuela", "Argentina", "Perú", "Chile", "Ecuador", "Brasil", "España", "Otro"]},
        {"id": "nationality", "name": "Nacionalidad", "required": True, "type": "text", "emoji": "🏳️"},
        {"id": "passport_number", "name": "Número de Pasaporte", "required": True, "type": "text", "emoji": "🛂"},
        {"id": "passport_expiry", "name": "Fecha de Expiración del Pasaporte", "required": True, "type": "date", "emoji": "📅"},
        {"id": "education_level", "name": "Nivel Educativo", "required": True, "type": "select", "emoji": "🎓",
        ...
        {"id": "english_level", "name": "Nivel de Inglés", "required": True, "type": "select", "emoji": "🇺🇸",
         "options": ["Nativo", "Avanzado", "Intermedio", "Básico", "Ninguno"]},
        {"id": "health_conditions", "name": "Condiciones de Salud", "required": True, "type": "boolean", "emoji": "🏥"},
        {"id": "health_details", "name": "Detalles de Salud", "required": False, "type": "long_text", "emoji": "📋"},
        {"id": "criminal_record", "name": "Antecedentes Penales", "required": True, "type": "boolean", "emoji": "⚖️"},
        {"id": "us_visa_history", "name": "Historial de Visas USA", "required": True, "type": "long_text", "emoji": "🇺🇸"},
        {"id": "work_plans_usa", "name": "¿Planea Trabajar en USA?", "required": True, "type": "boolean", "emoji": "💼"},
        {"id": "skills", "name": "Habilidades Principales", "required": False, "type": "long_text", "emoji": "⚡"},
    ],
    ...
    FamilyRole.CHILD: [
        ...
        {"id": "birth_date", "name": "Fecha de Nacimiento", "required": True, "type": "date", "emoji": "🎂"},
        {"id": "birth_country", "name": "País de Nacimiento", "required": True, "type": "select", "emoji": "🌍",
         "options": ["Colombia", "México", "Venezuela", "Argentina", "Perú", "Chile", "Ecuador", "Brasil", "España", "USA", "Otro"]},
        {"id": "nationality", "name": "Nacionalidad", "required": True, "type": "text", "emoji": "🏳️"},
        {"id": "passport_number", "name": "Número de Pasaporte", "required": False, "type": "text", "emoji": "🛂"},
        {"id": "passport_expiry", "name": "Fecha de Expiración del Pasaporte", "required": False, "type": "date", "emoji": "📅"},
        {"id": "current_grade", "name": "Grado Escolar Actual", "required": False, "type": "text", "emoji": "📚"},
        {"id": "school_name", "name": "Nombre del Colegio/Universidad", "required": False, "type": "text", "emoji": "🏫"},
        {"id": "english_level", "name": "Nivel de Inglés", "required": True, "type": "select", "emoji": "🇺🇸",
         "options": ["Nativo", "Avanzado", "Intermedio", "Básico", "Ninguno", "Muy pequeño para evaluar"]},
        {"id": "health_conditions", "name": "Condiciones de Salud", "required": True, "type": "boolean", "emoji": "🏥"},
        {"id": "health_details", "name": "Detalles de Salud", "required": False, "type": "long_text", "emoji": "📋"},
        {"id": "special_needs", "name": "Necesidades Especiales", "required": True, "type": "boolean", "emoji": "♿"},
        {"id": "special_needs_details", "name": "Detalles de Necesidades Especiales", "required": False, "type": "long_text", "emoji": "📋"},
        {"id": "vaccinations_complete", "name": "Vacunas Completas", "required": True, "type": "boolean", "emoji": "💉"},
        {"id": "hobbies", "name": "Hobbies e Intereses", "required": False, "type": "long_text", "emoji": "🎨"},
    ],
    ...
    FamilyRole.PARENT: [
        ...
        {"id": "health_conditions", "name": "Condiciones de Salud", "required": True, "type": "boolean", "emoji": "🏥"},
        {"id": "health_details", "name": "Detalles de Salud", "required": False, "type": "long_text", "emoji": "📋"},
        {"id": "medications", "name": "Medicamentos Regulares", "required": False, "type": "long_text", "emoji": "💊"},
        {"id": "mobility_issues", "name": "Problemas de Movilidad", "required": True, "type": "boolean", "emoji": "🦽"},
        {"id": "will_migrate", "name": "¿Migrará con la Familia?", "required": True, "type": "boolean", "emoji": "✈️"},
        {"id": "financial_dependent", "name": "¿Es Dependiente Financiero?", "required": True, "type": "boolean", "emoji": "💰"},
    ],
    
    FamilyRole.SIBLING: [
        {"id": "full_name", "name": "Nombre Completo", "required": True, "type": "text", "emoji": "👤"},
        {"id": "birth_date", "name": "Fecha de Nacimiento", "required": True, "type": "date", "emoji": "🎂"},
        {"id": "current_country", "name": "País de Residencia", "required": True, "type": "text", "emoji": "🌍"},
        {"id": "us_status", "name": "Estatus en USA (si aplica)", "required": False, "type": "select", "emoji": "🇺🇸",
         "options": ["Ciudadano", "Residente Permanente", "Visa de Trabajo", "Visa de Estudiante", "Otro", "No vive en USA"]},
        {"id": "can_sponsor", "name": "¿Puede Patrocinar?", "required": False, "type": "boolean", "emoji": "🤝"},
    ],
    
    FamilyRole.OTHER: [
        {"id": "full_name", "name": "Nombre Completo", "required": True, "type": "text", "emoji": "👤"},
        {"id": "relationship", "name": "Relación con el Solicitante", "required": True, "type": "text", "emoji": "👥"},
        {"id": "birth_date", "name": "Fecha de Nacimiento", "required": True, "type": "date", "emoji": "🎂"},
        {"id": "will_migrate", "name": "¿Migrará con la Familia?", "required": True, "type": "boolean", "emoji": "✈️"},
        {"id": "reason_for_inclusion", "name": "Razón para Incluir en el Caso", "required": True, "type": "long_text", "emoji": "📝"},
    ],
}
...
class FamilyProfiler:
    ...
    def validate_invitation(self, token: str) -> Optional[FamilyInvitation]:
    ...
    def accept_invitation(self, token: str, telegram_id: int) -> Optional[FamilyMember]:
    ...
    def update_member_field(self, member_id: str, field_id: str, value: Any) -> bool:
        ...
        member.profile_completion_percentage = (completed / len(required_fields) * 100) if required_fields else 100
...
"""
    ...
    def get_pending_invitations(self) -> List[FamilyInvitation]:
        ...
        return [inv for inv in self.invitations.values() if inv.status == InvitationStatus.PENDING and inv.is_valid()]
    
    def get_next_field_for_member(self, member_id: str) -> Optional[Dict]:
...
class FamilyInvitationHandler:
    ...
    @classmethod
    def get_invitation_info(cls, token: str) -> Optional[Dict]:
...
def create_family_profiler(principal_user_id: int, case_storage=None, bot_username: str = "MigPAL_Bot") -> FamilyProfiler:
