    ...
    if count == 0:
        ...
        mentors = [
            ...
            (
                ...
                2022,
                '["Spanish", "English"]',
                '["Digital Nomad", "Freelance", "Barcelona"]',
                4.7,
                28,
            ...
            (
                ...
                2020,
                '["Arabic", "English"]',
                '["Express Entry", "Engineering", "Ontario"]',
                4.7,
                38,
        ...
        lawyers = [
            (
                ...
                "USA",
                '["H-1B", "Green Card", "Asylum"]',
                '["Spanish", "English"]',
                "Fernández Immigration Law",
                "Miami, FL",
                150,
                4.8,
                127,
                1,
                "rfernandez@immigration.com",
                "https://fernandezlaw.com",
            ),
            (
                "Abg. Patricia Morales",
                "Canada",
                '["Express Entry", "PNP", "Refugee"]',
                '["Spanish", "English", "French"]',
                "Morales & Associates",
                "Toronto, ON",
                100,
                ...
                89,
                1,
                "pmorales@canadaimmigration.ca",
                "https://moraleslaw.ca",
            ),
            (
                "Abg. Juan García",
                "Spain",
                '["Work Visa", "Student", "Arraigo"]',
                '["Spanish"]',
                "García Extranjería",
                "Madrid",
                80,
                ...
                156,
                1,
                "jgarcia@extranjeria.es",
                "https://garciaextranjeria.es",
            ),
            (
                "RA Michael Schmidt",
                "Germany",
                '["Blue Card", "Work", "Family"]',
                '["Spanish", "English", "German"]',
                ...
                67,
                1,
                "mschmidt@immigration-de.com",
                "https://schmidt-law.de",
            ),
            (
                "Atty. Sarah Johnson",
                "USA",
                ...
                1,
                "sjohnson@jiglaw.com",
                "https://johnsonimmigration.com",
            ),
            (
                "Avv. Marco Rossi",
                "Italy",
                '["Work", "Student", "EU Blue Card"]',
                '["Italian", "English"]',
                "Studio Legale Rossi",
                "Milan",
                90,
                ...
                78,
                1,
                "mrossi@studiorossi.it",
                "https://studiorossi.it",
            ),
            (
                "Adv. Raj Patel",
                "UK",
                ...
                "Patel Immigration Solicitors",
                "London",
                130,
                4.8,
                145,
                1,
                "raj@patelimmigration.co.uk",
                "https://patelimmigration.co.uk",
            ),
            (
                "弁護士 Yuki Yamamoto",
                "Japan",
                '["Work", "Business", "Investor"]',
                '["Japanese", "English"]',
                "Yamamoto Legal Office",
                "Tokyo",
                180,
                4.7,
                56,
                1,
                "yuki@yamamoto-legal.jp",
                "https://yamamoto-legal.jp",
            ),
        ]
...
async def get_user(user_id: int) -> dict | None:
    """Get user data"""
    async with aiosqlite.connect(DB_PATH) as db:
        cursor = await db.execute("SELECT profile_data FROM users WHERE user_id = ?", (user_id,))
