...
from app.utils.ai_assistant import build_ai_context, chat_with_ai
...
async def chat(
    ...
    # Get AI response
    ai_response = await chat_with_ai(message=message_data.message, context=context)
...
async def get_personalized_guidance(
    ...
    return {"guidance": guidance, "profile": profile, "process": migration_process}
