...
from app.services.case_storage import load_user_data, list_all_cases, CASES_DIR
from app.services.translations import get_text, TRANSLATIONS
...
ENGLISH_MARKERS = [
    ...
    "Your Profile", "What is your", "Please write", "Select your",
    "Yes, that's correct", "No, I want to change"
]
SPANISH_MARKERS = [
    "FASE 1:", "FASE 2:", "FASE 3:", "FASE 4:", "FASE 5:", "FASE 6:",
    "Tu Perfil", "¿Cuál es tu", "Por favor escribe", "Selecciona tu",
    "Sí, es correcto", "No, quiero cambiarlo"
]
