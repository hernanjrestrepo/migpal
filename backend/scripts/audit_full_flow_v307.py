...
class FlowAuditor:
    ...
    def get_full_flow_steps(self) -> list[FlowStep]:
        ...
        return [
            ...
            FlowStep(
                "onboarding_consent", "callback", "onboarding_yes", "onboarding_name", "Aceptar empezar"
            ),
            ...
            FlowStep(
                "discovery_why", "callback", "flow_why_work", "discovery_dream", "Seleccionar razón: trabajo"
            ),
            FlowStep(
                "discovery_dream",
                "message",
                "Quiero ser ingeniero de software en Silicon Valley",
                "discovery_family",
                "Describir sueño",
            ),
            FlowStep(
            ...
            FlowStep(
                "discovery_usa_connections",
                "callback",
                "flow_connections_none",
                "life_work_or_business",
                "Indicar conexiones USA",
            ),
            # === LIFE PLAN ===
            FlowStep("life_work_or_business", "callback", "flow_work", "life_profession", "Elegir trabajo"),
            FlowStep(
                "life_profession", "message", "Ingeniero de Software", "life_experience", "Indicar profesión"
            ),
            ...
            FlowStep(
                "life_remote", "callback", "flow_remote_hybrid", "location_region", "Preferencia remoto"
            ),
            # === LOCATION ===
            ...
            FlowStep(
                "location_confirm",
                "callback",
                "flow_location_confirm",
                "visa_analysis",
                "Confirmar ubicación",
            ),
            # === VISA ANALYSIS ===
            FlowStep(
                "visa_analysis", "callback", "flow_visa_start", "visa_recommendation", "Iniciar análisis visa"
            ),
            FlowStep(
                "visa_recommendation",
                "callback",
