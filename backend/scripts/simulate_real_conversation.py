...
from app.services.profile_validator import (
    get_profile_validator, PriorityIntentHandler, get_profile_based_intro
)
        ...
        for i, msg in enumerate(scenario.messages):
            ...
            if msg.expected_intent:
                ...
                if msg.expected_intent.lower() in str(detected_intent).lower():
                    ...
                    results["errors"].append(f"Intent incorrecto en mensaje {i+1}: esperado {msg.expected_intent}, obtenido {detected_intent}")
            ...
            if analysis["priority_intent"]["should_interrupt"]:
                if analysis["priority_intent"]["empathic_response"]:
                    ...
                    print(f"⚠️ Sin respuesta empática para intent prioritario")
