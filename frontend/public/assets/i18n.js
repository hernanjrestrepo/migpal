...
window.MigPALi18n = (function () {
  ...
  var DICT = {
    ...
    /* --------------------------------------------- presupuesto (Hito 5) */
    'budget.title': { es: 'Presupuesto y ROI', pt: 'Orçamento e ROI', en: 'Budget and ROI' },
    'budget.sub': { es: 'Cuánto cuesta migrar y en cuánto tiempo se recupera la inversión.', pt: 'Quanto custa migrar e em quanto tempo o investimento se recupera.', en: 'How much migrating costs and how long it takes to pay off.' },
    'budget.familySize': { es: 'Personas en el grupo familiar', pt: 'Pessoas no grupo familiar', en: 'People in the family group' },
    'budget.originIncome': { es: 'Ingreso mensual actual (origen)', pt: 'Renda mensal atual (origem)', en: 'Current monthly income (origin)' },
    'budget.destIncome': { es: 'Ingreso mensual proyectado (destino)', pt: 'Renda mensal projetada (destino)', en: 'Projected monthly income (destination)' },
    'budget.govFee': { es: 'Tasa de gobierno estimada', pt: 'Taxa de governo estimada', en: 'Estimated government fee' },
    'budget.relocationLow': { es: 'Traslado — estimado mínimo', pt: 'Traslado — estimativa mínima', en: 'Relocation — low estimate' },
    'budget.relocationHigh': { es: 'Traslado — estimado máximo', pt: 'Traslado — estimativa máxima', en: 'Relocation — high estimate' },
    'budget.settlementCost': { es: 'Instalación inicial (vivienda, trámites)', pt: 'Instalação inicial (moradia, trâmites)', en: 'Initial settlement (housing, paperwork)' },
    'budget.legalLow': { es: 'Asesoría legal — mínimo (opcional)', pt: 'Assessoria jurídica — mínimo (opcional)', en: 'Legal advice — low (optional)' },
    'budget.legalHigh': { es: 'Asesoría legal — máximo (opcional)', pt: 'Assessoria jurídica — máximo (opcional)', en: 'Legal advice — high (optional)' },
    'budget.hint': { es: 'MigPAL solo calcula con autoridad propia su propia tarifa de servicio. El resto son estimados que tú aportas — no inventamos tasas de gobierno ni costos legales.', pt: 'O MigPAL só calcula com autoridade própria sua própria tarifa de serviço. O resto são estimativas que você fornece — não inventamos taxas de governo nem custos legais.', en: 'MigPAL only calculates its own service fee with authority. Everything else is an estimate you provide — we don’t invent government fees or legal costs.' },
    'budget.submit': { es: 'Calcular mi presupuesto', pt: 'Calcular meu orçamento', en: 'Calculate my budget' },
    'budget.recalculate': { es: 'Volver a calcular', pt: 'Calcular novamente', en: 'Recalculate' },
    'budget.emptyTitle': { es: 'Todavía no calculaste tu presupuesto', pt: 'Você ainda não calculou seu orçamento', en: 'You haven’t calculated your budget yet' },
    'budget.emptyBody': { es: 'Completa los campos y calcula cuánto cuesta tu proyecto migratorio.', pt: 'Preencha os campos e calcule quanto custa seu projeto migratório.', en: 'Fill in the fields and calculate how much your migration project costs.' },
    'budget.breakdownTitle': { es: 'Desglose de costos', pt: 'Detalhamento de custos', en: 'Cost breakdown' },
    'budget.feeMigpal': { es: 'Servicio MigPAL', pt: 'Serviço MigPAL', en: 'MigPAL service' },
    'budget.feeGov': { es: 'Tasa de gobierno', pt: 'Taxa de governo', en: 'Government fee' },
    'budget.feeRelocation': { es: 'Traslado', pt: 'Traslado', en: 'Relocation' },
    'budget.feeSettlement': { es: 'Instalación', pt: 'Instalação', en: 'Settlement' },
    'budget.feeLegal': { es: 'Asesoría legal', pt: 'Assessoria jurídica', en: 'Legal advice' },
    'budget.total': { es: 'Total estimado', pt: 'Total estimado', en: 'Total estimate' },
    'budget.balanceTitle': { es: 'Balance financiero migratorio', pt: 'Balanço financeiro migratório', en: 'Migration financial balance' },
    'budget.monthlyDiff': { es: 'Diferencial mensual', pt: 'Diferencial mensal', en: 'Monthly differential' },
    'budget.breakeven': { es: 'Meses para recuperar la inversión', pt: 'Meses para recuperar o investimento', en: 'Months to break even' },
    ...
    /* ------------------------------------------- planificación (Hito 5) */
    'family.title': { es: 'Planificación familiar', pt: 'Planejamento familiar', en: 'Family planning' },
    'family.sub': { es: 'Dónde te vas a instalar y qué necesita tu familia para llegar bien.', pt: 'Onde você vai se instalar e o que sua família precisa para chegar bem.', en: 'Where you’ll settle and what your family needs to land well.' },
    'family.geoTitle': { es: 'Geografía', pt: 'Geografia', en: 'Geography' },
    'family.geoSub': { es: 'Elige en orden: país, luego estado/provincia, luego ciudad, luego barrio.', pt: 'Escolha em ordem: país, depois estado/província, depois cidade, depois bairro.', en: 'Choose in order: country, then state/province, then city, then neighborhood.' },
    'family.country': { es: 'País', pt: 'País', en: 'Country' },
    'family.state': { es: 'Estado / Provincia', pt: 'Estado / Província', en: 'State / Province' },
    'family.city': { es: 'Ciudad', pt: 'Cidade', en: 'City' },
    'family.neighborhood': { es: 'Barrio', pt: 'Bairro', en: 'Neighborhood' },
    'family.save': { es: 'Guardar', pt: 'Salvar', en: 'Save' },
    'family.surveyTitle': { es: 'Encuesta familiar', pt: 'Pesquisa familiar', en: 'Family survey' },
    'family.surveySub': { es: 'Cuéntanos qué es importante para ustedes al elegir dónde vivir.', pt: 'Conte-nos o que é importante para vocês ao escolher onde morar.', en: 'Tell us what matters to you when choosing where to live.' },
    'family.climate': { es: 'Preferencia de clima', pt: 'Preferência de clima', en: 'Climate preference' },
    'family.topPriority': { es: 'Prioridad principal (colegio, costo, cercanía a trabajo…)', pt: 'Prioridade principal (escola, custo, proximidade do trabalho…)', en: 'Top priority (school, cost, commute…)' },
    'family.notes': { es: 'Notas adicionales', pt: 'Notas adicionais', en: 'Additional notes' },
    'family.surveySubmit': { es: 'Guardar respuesta', pt: 'Salvar resposta', en: 'Save response' },
    'family.surveyProgress': { es: '{done} de {total} integrantes respondieron', pt: '{done} de {total} integrantes responderam', en: '{done} of {total} family members answered' },
    'family.optionsTitle': { es: 'Colegios y vivienda', pt: 'Escolas e moradia', en: 'Schools and housing' },
    'family.optionsSub': { es: 'Guarda las opciones que vayas encontrando, con su costo y contacto.', pt: 'Salve as opções que for encontrando, com custo e contato.', en: 'Save the options you find, with cost and contact info.' },
    'family.optionType': { es: 'Tipo', pt: 'Tipo', en: 'Type' },
    'family.optionType.SCHOOL': { es: 'Colegio', pt: 'Escola', en: 'School' },
    'family.optionType.HOUSING': { es: 'Vivienda', pt: 'Moradia', en: 'Housing' },
    'family.optionName': { es: 'Nombre', pt: 'Nome', en: 'Name' },
    'family.optionWebsite': { es: 'Sitio web (opcional)', pt: 'Site (opcional)', en: 'Website (optional)' },
    'family.optionPhone': { es: 'Teléfono (opcional)', pt: 'Telefone (opcional)', en: 'Phone (optional)' },
    'family.optionRequirements': { es: 'Requisitos (opcional)', pt: 'Requisitos (opcional)', en: 'Requirements (optional)' },
    'family.optionCost': { es: 'Costo (opcional)', pt: 'Custo (opcional)', en: 'Cost (optional)' },
    'family.optionCostPeriod': { es: 'Período (ej: mensual)', pt: 'Período (ex: mensal)', en: 'Period (e.g. monthly)' },
    'family.addOption': { es: 'Agregar opción', pt: 'Adicionar opção', en: 'Add option' },
    'family.noOptions': { es: 'Todavía no agregaste ninguna opción.', pt: 'Você ainda não adicionou nenhuma opção.', en: 'You haven’t added any options yet.' },
    'toast.familyGeoSaved': { es: 'Guardado.', pt: 'Salvo.', en: 'Saved.' },
    'toast.familySurveySaved': { es: 'Respuesta guardada.', pt: 'Resposta salva.', en: 'Response saved.' },
    'toast.familyOptionAdded': { es: 'Opción agregada.', pt: 'Opção adicionada.', en: 'Option added.' },

    /* ----------------------------------------------- comunidad (Hito 5) */
    'community.title': { es: 'Comunidad', pt: 'Comunidade', en: 'Community' },
    'community.sub': { es: 'Conecta con otros migrantes en tu ciudad de destino.', pt: 'Conecte-se com outros migrantes na sua cidade de destino.', en: 'Connect with other migrants in your destination city.' },
    'community.newGroup': { es: 'Nuevo grupo', pt: 'Novo grupo', en: 'New group' },
    'community.groupName': { es: 'Nombre del grupo', pt: 'Nome do grupo', en: 'Group name' },
    'community.groupDesc': { es: 'Descripción (opcional)', pt: 'Descrição (opcional)', en: 'Description (optional)' },
    'community.groupCity': { es: 'Ciudad (opcional)', pt: 'Cidade (opcional)', en: 'City (optional)' },
    'community.groupCountry': { es: 'País (opcional)', pt: 'País (opcional)', en: 'Country (optional)' },
    'community.createGroup': { es: 'Crear grupo', pt: 'Criar grupo', en: 'Create group' },
    'community.join': { es: 'Unirme', pt: 'Participar', en: 'Join' },
    'community.member': { es: 'Miembro', pt: 'Membro', en: 'Member' },
    'community.members': { es: '{n} miembros', pt: '{n} membros', en: '{n} members' },
    'community.viewPosts': { es: 'Ver publicaciones', pt: 'Ver publicações', en: 'View posts' },
    'community.noGroups': { es: 'Todavía no hay grupos. Crea el primero.', pt: 'Ainda não há grupos. Crie o primeiro.', en: 'No groups yet. Create the first one.' },
    'community.postPlaceholder': { es: '¿Qué quieres compartir con el grupo?', pt: 'O que você quer compartilhar com o grupo?', en: 'What do you want to share with the group?' },
    'community.publish': { es: 'Publicar', pt: 'Publicar', en: 'Post' },
    'community.joinToPost': { es: 'Únete al grupo para publicar.', pt: 'Participe do grupo para publicar.', en: 'Join the group to post.' },
    'community.noPosts': { es: 'Todavía no hay publicaciones en este grupo.', pt: 'Ainda não há publicações neste grupo.', en: 'No posts in this group yet.' },
    'community.like': { es: '👍 Me gusta', pt: '👍 Curtir', en: '👍 Like' },
    'community.liked': { es: '💙 Te gusta', pt: '💙 Você curtiu', en: '💙 You liked this' },
    'community.comments': { es: '{n} comentarios', pt: '{n} comentários', en: '{n} comments' },
    'community.commentPlaceholder': { es: 'Escribe un comentario…', pt: 'Escreva um comentário…', en: 'Write a comment…' },
    'community.send': { es: 'Enviar', pt: 'Enviar', en: 'Send' },
    'community.back': { es: '← Todos los grupos', pt: '← Todos os grupos', en: '← All groups' },
    'toast.groupCreated': { es: 'Grupo creado.', pt: 'Grupo criado.', en: 'Group created.' },
    'toast.groupJoined': { es: 'Ahora eres miembro del grupo.', pt: 'Agora você é membro do grupo.', en: 'You’re now a group member.' },
    'toast.postPublished': { es: 'Publicación creada.', pt: 'Publicação criada.', en: 'Post published.' },
    'toast.commentAdded': { es: 'Comentario agregado.', pt: 'Comentário adicionado.', en: 'Comment added.' },

    /* -------------------------------------------------- mercado (Hito 5) */
    'market.title': { es: 'Mercado', pt: 'Mercado', en: 'Marketplace' },
    'market.sub': { es: 'Servicios entre migrantes — MigPAL es intermediario, no agencia.', pt: 'Serviços entre migrantes — o MigPAL é intermediário, não agência.', en: 'Services between migrants — MigPAL is an intermediary, not an agency.' },
    'market.category.PLOMERIA': { es: 'Plomería', pt: 'Encanamento', en: 'Plumbing' },
    'market.category.PINTURA': { es: 'Pintura', pt: 'Pintura', en: 'Painting' },
    'market.category.CUIDADO_INFANTIL': { es: 'Cuidado infantil', pt: 'Cuidado infantil', en: 'Childcare' },
    'market.category.MUDANZAS': { es: 'Mudanzas', pt: 'Mudanças', en: 'Moving' },
    'market.category.CLASES': { es: 'Clases', pt: 'Aulas', en: 'Classes' },
    'market.category.BELLEZA': { es: 'Belleza', pt: 'Beleza', en: 'Beauty' },
    'market.category.ELECTRICIDAD': { es: 'Electricidad', pt: 'Eletricidade', en: 'Electrical' },
    'market.category.OTRO': { es: 'Otro', pt: 'Outro', en: 'Other' },
    'market.listingsTitle': { es: 'Servicios disponibles', pt: 'Serviços disponíveis', en: 'Available services' },
    'market.categoryLabel': { es: 'Categoría', pt: 'Categoria', en: 'Category' },
    'market.noListings': { es: 'Todavía no hay servicios publicados.', pt: 'Ainda não há serviços publicados.', en: 'No services published yet.' },
    'market.buy': { es: 'Contratar', pt: 'Contratar', en: 'Hire' },
    'market.yourOwn': { es: 'Tu publicación', pt: 'Sua publicação', en: 'Your listing' },
    'market.newListingTitle': { es: 'Publicar un servicio', pt: 'Publicar um serviço', en: 'Publish a service' },
    'market.listingTitle': { es: 'Título', pt: 'Título', en: 'Title' },
    'market.listingDesc': { es: 'Descripción (opcional)', pt: 'Descrição (opcional)', en: 'Description (optional)' },
    'market.listingCity': { es: 'Ciudad (opcional)', pt: 'Cidade (opcional)', en: 'City (optional)' },
    'market.price': { es: 'Precio', pt: 'Preço', en: 'Price' },
    'market.priceUnit': { es: 'Unidad (ej: hora, servicio)', pt: 'Unidade (ex: hora, serviço)', en: 'Unit (e.g. hour, job)' },
    'market.publish': { es: 'Publicar servicio', pt: 'Publicar serviço', en: 'Publish service' },
    'market.myTransactions': { es: 'Mis transacciones', pt: 'Minhas transações', en: 'My transactions' },
    'market.noTransactions': { es: 'Todavía no tienes transacciones.', pt: 'Você ainda não tem transações.', en: 'You don’t have any transactions yet.' },
    'market.complete': { es: 'Marcar completada', pt: 'Marcar como concluída', en: 'Mark completed' },
    'market.cancel': { es: 'Cancelar', pt: 'Cancelar', en: 'Cancel' },
    'market.status.PENDING': { es: 'Pendiente', pt: 'Pendente', en: 'Pending' },
    'market.status.COMPLETED': { es: 'Completada', pt: 'Concluída', en: 'Completed' },
    'market.status.CANCELLED': { es: 'Cancelada', pt: 'Cancelada', en: 'Cancelled' },
    'market.commission': { es: 'Comisión MigPAL: {n}', pt: 'Comissão MigPAL: {n}', en: 'MigPAL commission: {n}' },
    ...
    /* ------------------------------------------------- negocio (Hito 5) */
    'negocio.title': { es: 'Negocio propio', pt: 'Negócio próprio', en: 'Your own business' },
    'negocio.sub': { es: 'Presenta tu idea a la junta directiva de ADAN — IA, no personas reales.', pt: 'Apresente sua ideia à diretoria da ADAN — IA, não pessoas reais.', en: 'Pitch your idea to ADAN’s board — AI, not real people.' },
    'negocio.ideaName': { es: 'Nombre de la idea', pt: 'Nome da ideia', en: 'Idea name' },
    'negocio.ideaDesc': { es: 'Describe tu idea', pt: 'Descreva sua ideia', en: 'Describe your idea' },
    'negocio.industry': { es: 'Industria (opcional)', pt: 'Indústria (opcional)', en: 'Industry (optional)' },
    'negocio.country': { es: 'País (opcional)', pt: 'País (opcional)', en: 'Country (optional)' },
    'negocio.connect': { es: 'Presentar mi idea', pt: 'Apresentar minha ideia', en: 'Pitch my idea' },
    'negocio.boardTitle': { es: 'Junta directiva (ADAN)', pt: 'Diretoria (ADAN)', en: 'Board room (ADAN)' },
    'negocio.messagePh': { es: 'Pregúntale algo a la junta sobre tu negocio…', pt: 'Pergunte algo à diretoria sobre seu negócio…', en: 'Ask the board something about your business…' },
    'negocio.ask': { es: 'Consultar a la junta', pt: 'Consultar a diretoria', en: 'Ask the board' },
    'negocio.decision': { es: 'Decisión', pt: 'Decisão', en: 'Decision' },
    'negocio.score': { es: 'Puntaje {n}/100 · Confianza {c}%', pt: 'Pontuação {n}/100 · Confiança {c}%', en: 'Score {n}/100 · Confidence {c}%' },
    'toast.negocioConnected': { es: 'Idea presentada. Ya puedes consultar a la junta.', pt: 'Ideia apresentada. Você já pode consultar a diretoria.', en: 'Idea pitched. You can now ask the board.' },

    /* -------------------------------------------------- empleo (Hito 5) */
    'empleo.title': { es: 'Empleo', pt: 'Emprego', en: 'Employment' },
    'empleo.sub': { es: 'Conecta tu perfil con JobXeeker y busca ofertas reales.', pt: 'Conecte seu perfil ao JobXeeker e busque vagas reais.', en: 'Connect your profile to JobXeeker and search real openings.' },
    'empleo.name': { es: 'Nombre completo', pt: 'Nome completo', en: 'Full name' },
    'empleo.roles': { es: 'Roles buscados (separados por coma)', pt: 'Cargos buscados (separados por vírgula)', en: 'Target roles (comma-separated)' },
    'empleo.industries': { es: 'Industrias de interés (separadas por coma)', pt: 'Indústrias de interesse (separadas por vírgula)', en: 'Target industries (comma-separated)' },
    'empleo.location': { es: 'Ubicación preferida', pt: 'Localização preferida', en: 'Preferred location' },
    'empleo.experience': { es: 'Nivel de experiencia', pt: 'Nível de experiência', en: 'Experience level' },
    'empleo.skills': { es: 'Habilidades (separadas por coma)', pt: 'Habilidades (separadas por vírgula)', en: 'Skills (comma-separated)' },
    'empleo.connect': { es: 'Conectar mi perfil', pt: 'Conectar meu perfil', en: 'Connect my profile' },
    'empleo.search': { es: 'Buscar empleos', pt: 'Buscar empregos', en: 'Search jobs' },
    'empleo.evaluated': { es: '{n} ofertas evaluadas, {m} nuevas coincidencias', pt: '{n} vagas avaliadas, {m} novas correspondências', en: '{n} jobs evaluated, {m} new matches' },
    'empleo.degraded': { es: 'El motor de matching de JobXeeker no está disponible en este momento.', pt: 'O motor de matching do JobXeeker não está disponível no momento.', en: 'JobXeeker’s matching engine isn’t available right now.' },
    'empleo.noMatches': { es: 'Todavía no hay coincidencias.', pt: 'Ainda não há correspondências.', en: 'No matches yet.' },
    'toast.empleoConnected': { es: 'Perfil conectado. Ya puedes buscar empleos.', pt: 'Perfil conectado. Você já pode buscar empregos.', en: 'Profile connected. You can now search for jobs.' },
